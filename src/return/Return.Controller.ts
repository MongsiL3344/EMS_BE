...
import { getRentedItemListService } from './Return.Service.js';
import type {SessionCheckResult} from "../types/User.Type.js";
...
export async function getRentedListController(req: Request, res: Response) {
  ...
  try {
    ...
    console.log('Rented List Result : ', getRentedListResult);
